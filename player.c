...
p->position_joueur.y=530;
}

//------------------------------------------------------------------------------------//
void init_perso2(pers *p2)
{
    p2->depart= IMG_Load("p2_choix.png");// position initiale du personnage
    // animation deplacement personnage a droite
    p2->droite[0] = IMG_Load("p2_droit1.png"); 
    p2->droite[1] = IMG_Load("p2_droit2.png");
    p2->droite[2] = IMG_Load("p2_droit3.png");
    p2->droite[3] = IMG_Load("p2_droit4.png");

    // animation deplacement personnage a gauche    
    p2->gauche[0] = IMG_Load("p2_gauche1.png");
    p2->gauche[1] = IMG_Load("p2_gauche2.png");
    p2->gauche[2] = IMG_Load("p2_gauche3.png");
    p2->gauche[3] = IMG_Load("p2_gauche4.png");

p2->right=0;
p2->left=0;

p2->position_joueur.x=300;
p2->position_joueur.y=530;
}
//-----------------------------------------------------------------------------------//
...
//------------------------------------------------------------------------------------//
void bouger_droite(SDL_Surface *screen, pers *p,background *backg)
{
SDL_BlitSurface(p->droite[p->right],NULL,screen,&p->position_joueur);
...
void bouger_gauche(SDL_Surface *screen, pers *p,background *backg)
{
SDL_BlitSurface(p->gauche[p->left],NULL,screen,&p->position_joueur);
   p->position_joueur.x-=5;
   SDL_Delay(40);
