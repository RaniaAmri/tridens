...
{
back->background=IMG_Load("sbackground.png");
...
{
SDL_BlitSurface(back->background,NULL,screen,&back->position_background);
}
...
ttf->texte =TTF_RenderText_Blended(ttf->police,"CREATED BY Rania", couleurViloet);
