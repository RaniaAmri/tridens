prog:player.o main.o backg.o sous_menu.o collision.o jouer.o menu.o sauvgarde.o entite.o
	gcc player.o main.o backg.o sous_menu.o jouer.o menu.c collision.o sauvgarde.o entite.o -o prog  -lSDL -lSDL_image -lSDL_mixer -lSDL_ttf -g
main.o:main.c
...
entite.o.o:entite.o.c
	gcc -c entite.c -lSDL -lSDL_image -lSDL_mixer -lSDL_ttf -g
